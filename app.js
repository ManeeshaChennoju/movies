...
app.get("/directors/:directorId/movies/", async (request, response) => {
  ...
  //   const changedMoviesLis = [];
  //   for (let obj of moviesNamesLis) {
  //     changedMoviesLis.push(convertMovieName(obj));
  //   }
  const changeMovieList = moviesNamesLis.map(convertMovieName);
